...
class PagerPhotoFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewpage2.setCurrentItem(arguments?.getInt("PHOTO_POSITION") ?: 0, false)
    ...
    private suspend fun savePhoto() {
        withContext(Dispatchers.IO) {
            val holder =
                (viewpage2[0] as RecyclerView).findViewHolderForAdapterPosition(viewpage2.currentItem) as MyViewHolder
            val bitmap = holder.itemView.ing_pager_photo.drawable.toBitmap()
